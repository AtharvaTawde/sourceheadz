...
public class CharacterController2D : MonoBehaviour {
	...
	private float hypermobilityConstant = 1;
	...
	private void Update() {
		...
		hypermobilityConstant = player.hypermobility > 0 ? 1.5f : 1f;
	...
	public void Move(float move, bool crouch, bool jump) {	
		...
		if (m_Grounded && jump) {
			m_Grounded = false;
			m_Rigidbody2D.AddForce(new Vector2(0f, m_JumpForce * hypermobilityConstant));
		}
	}
